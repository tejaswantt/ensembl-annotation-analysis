...
The relationship between gene length and transcript count appears weaker.
...
Working with Ensembl GTF data helped identify important annotation metrics that are commonly used to evaluate genome annotation quality and structural complexity.

This project serves as an initial step toward developing reusable Python modules that compute genome annotation metrics and perform comparative analysis across multiple species. The work presented in this repository is intended as preparation for contributing to the Ensembl GSoC project focused on annotation metrics reporting and comparative analysis modules.
